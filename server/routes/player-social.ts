...
router.get("/api/debug/search-players", async (req: Request, res: Response) => {
    try {
...
router.get("/api/debug/recent-users", async (req: Request, res: Response) => {
    try {
...
router.get("/api/debug/player/:playerId", async (req: Request, res: Response) => {
    try {
      const { playerId } = req.params;
...
router.post("/api/debug/reset-onboarding/:playerId", async (req: Request, res: Response) => {
    try {
      const { playerId } = req.params;
  ...
  if (process.env.NODE_ENV === 'development') {
    router.get("/api/dev/players/search", async (req: Request, res: Response) => {
      try {
    ...
    router.post("/api/dev/players/:id/set-level", async (req: Request, res: Response) => {
      try {
        const { id } = req.params;
        ...
        router.post("/api/dev/players/:id/reset-onboarding", async (req: Request, res: Response) => {
      try {
