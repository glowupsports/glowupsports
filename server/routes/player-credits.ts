import { Router, type Response } from "express";
  ...
  import { authMiddlewareWithFreshData as authMiddleware, requireRole, requireAcademy, validatePlayerOwnership, validateSessionOwnership, validatePackageOwnership, type AuthenticatedRequest } from "../auth"; import { sanitizeNote } from "../utils/sanitize"; import { playerMonthlyAssessments } from "@shared/schema"; const router = Router();
  ...
  router.post(
    ...
    async (req: AuthenticatedRequest, res: Response) => {
      try {
        ...
        const _player = await storage.getPlayer(playerId);
