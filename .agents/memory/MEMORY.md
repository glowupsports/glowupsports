...
- [GitHub npm install crash](github-npm-install-crash.md) — GitHub runners can crash inside npm after dependency extraction; distinguish this from project check failures.
