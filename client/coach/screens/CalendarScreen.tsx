...
const styles = StyleSheet.create({
  ...
  courtHeaders: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: Colors.dark.primary + "25",
    borderTopWidth: 1,
    borderTopColor: Colors.dark.primary + "15",
  },
  timeColumnHeader: {
  ...
  // Premium Month View styles (Gaming HUD)
  monthModeToggle: {
    flexDirection: "row",
    backgroundColor: Colors.dark.backgroundSecondary,
    borderRadius: BorderRadius.md,
  ...
  weekDayHeader: {
    ...
    paddingVertical: Spacing.sm,
    borderLeftWidth: 1,
    borderLeftColor: Colors.dark.primary + "12",
  },
  weekDayHeaderToday: {
  ...
  weekDayColumn: {
    ...
    position: "relative",
    borderLeftWidth: 1,
    borderLeftColor: Colors.dark.primary + "10",
  },
  weekDayColumnToday: {
  ...
  weekHourSlot: {
    borderBottomWidth: 1,
    borderBottomColor: Colors.dark.primary + "10",
  },
  weekHourLine: {
    position: "absolute",
    top: 0,
  ...
  weekHalfHourLine: {
    ...
    right: 0,
    height: 1,
    backgroundColor: Colors.dark.primary + "06",
  },
  weekSessionBlock: {
    position: "absolute",
    left: 2,
  ...
  // Day Context Panel styles (Gaming HUD)
  dayContextPanel: {
    paddingHorizontal: Spacing.lg,
    paddingVertical: Spacing.md,
    marginHorizontal: Spacing.md,
