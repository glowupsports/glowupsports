            ...
            {[3, 2, 1].map((level) => (
              ...
              >
                <Text style={[
                  ...
                  selectedSublevel === level && { color: levelColor }
                ]}>
                  {level}
                </Text>
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryHeader}>
              <View style={[styles.summaryAvatar, { backgroundColor: levelColor + "30" }]}>
                <Text style={[styles.summaryInitial, { color: levelColor }]}>
              ...
              <View style={styles.summaryHeaderInfo}>
                ...
                <View style={[styles.summaryLevelBadge, { backgroundColor: levelColor + "20", borderColor: levelColor }]}>
                  ...
                  <Text style={[styles.summaryLevelText, { color: levelColor }]}>{levelDisplay}</Text>
                </View>
              </View>
            </View>
