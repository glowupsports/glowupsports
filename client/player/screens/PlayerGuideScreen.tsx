...
const FAQ_IDS: { id: string; category: FAQCategoryKey }[] = [
  ...
  { id: "creditExpiry", category: "Billing" },
  { id: "findPlayers", category: "Social" },
  { id: "openMatch", category: "Social" },
  { id: "matchResult", category: "Social" },
  { id: "spotlight", category: "Social" },
  { id: "communityFeed", category: "Social" },
