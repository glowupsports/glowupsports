...
function PlayerV2TabView() {
  ...
  const tabs: TabConfig[] = useMemo(() => [
    ...
    { key: "PlayStack", label: "Play",   icon: "game-controller-outline", iconFocused: "game-controller", component: PlayStackNavigator, keepAlive: true },
    { key: "Growth",    label: "Growth", icon: "trending-up-outline",     iconFocused: "trending-up",     component: ProgressStackNavigator, keepAlive: true },
