...
import ArenaShopScreen from "@/player/screens/arena/ArenaShopScreen";
...
export type PlayerV2StackParamList = {
  ...
  // Arena Phase 4
  ArenaShop: undefined;
  ArenaTrophyRoom: undefined;
  ArenaAcademyClash: undefined;
  ArenaGlobalTournament: undefined;
  ...
  const stackContent = (
    <View style={styles.flex}>
      ...
      <Stack.Navigator screenOptions={{ headerShown: false, animation: "none", gestureEnabled: false }}>
        ...
        {/* ── Arena ── */}
        <Stack.Screen name="ArenaHub" component={ArenaHubScreen} options={({ navigation }) => ({ presentation: "fullScreenModal", animation: "slide_from_bottom", headerShown: true, headerTransparent: true, headerTitle: "Glow Arena", headerTintColor: Colors.dark.text, headerTitleStyle: { color: Colors.dark.text, fontWeight: "600" }, headerBackVisible: false, headerLeft: () => (<HeaderButton onPress={() => navigation.goBack()}><Feather name="x" size={22} color={Colors.dark.text} /></HeaderButton>) })} />
        ...
        <Stack.Screen name="ArenaShop" component={ArenaShopScreen} options={{ presentation: "card", headerShown: true, headerTitle: "Arena Shop", headerStyle: { backgroundColor: Colors.dark.backgroundRoot }, headerTintColor: Colors.dark.text, headerTransparent: true }} />
