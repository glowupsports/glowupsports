...
const DRAWER_SECTIONS: DrawerSection[] = [
  ...
  },
  {
    ...
    icon: "rocket",
    items: [
      { id: "dailyquests", title: "Daily Quests", subtitle: "Today's challenges", icon: "flash", screen: "PlayerTabs", params: { screen: "Quests" } },
      { id: "weeklyquests", title: "Weekly Quests", subtitle: "This week's goals", icon: "flame", screen: "PlayerTabs", params: { screen: "Quests" } },
      { id: "rewards", title: "Claim Rewards", subtitle: "Your earned prizes", icon: "gift", screen: "PlayerTabs", params: { screen: "Quests" } },
